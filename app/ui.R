...
# Define Custom CSS for Dashboard
            ...
            div(
              ...
              div(
                ...
                p(
                  ...
                  #"GAM Platform for Temporal and Climatic Analysis of Malaria in Ghana",
                  #"Advanced Analytics and Forecasting for Malaria Control in Ghana",
                  #style = "color: white; font-size: 2.10rem; margin-top: 15px; opacity: 0.95;"
                )
              )
            )
      ...
      tabItem(
        ...
        fluidRow(
          ...
          column(
            ...
            # Line Plots filter — only shown when Line Plots tab is active
            conditionalPanel(
            ...
            # Heatmaps filter — only shown when Heatmaps tab is active
            conditionalPanel(
            ...
            # Seasonal Pattern filter — only shown when Seasonal Pattern tab is active
            conditionalPanel(
              ...
              box(
                ...
                dateRangeInput(
                  ...
                  min   = min(data$date, na.rm = TRUE),
                  max   = max(data$date, na.rm = TRUE),
                  format = "yyyy"      # show only year to discourage partial-year selection
                ),
                hr(),
                downloadButton(
                  "download_plot",
          ...
          column(
            ...
            tabBox(
              width = 12,
              id = "appendix_tabs",  # <-- CRITICAL: id must match conditionalPanel condition
          ...
          box(
            ...
            div(
              ...
              div(
                ...
                tags$a(
                  href   = "https://github.com/EdwardAkurugu/SEIR-model/",
                  target = "_blank",
