...
server <- function(input, output, session) {
  ...
  output$observed_plot <- renderPlotly({
    ...
    # ggsave(paste0("decompose_observed_plot_", input$region, ".tiff"), plot,
    #        device = "tiff", width = 2250, height = 1300,
    #        units = "px", dpi = 600, compression = "lzw")
  ...
  output$trend_plot <- renderPlotly({
    ...
    # ggsave(paste0("decompose_trend_plot_", input$region, ".tiff"), plot,
    #        device = "tiff", width = 2250, height = 1300,
    #        units = "px", dpi = 600, compression = "lzw")
    make_static_plotly(plot,
  ...
  output$seasonal_plot <- renderPlotly({
    ...
    # ggsave(paste0("decompose_seasonal_plot_", input$region, ".tiff"), plot,
    #        device = "tiff", width = 2250, height = 1300,
    #        units = "px", dpi = 600, compression = "lzw")
    make_static_plotly(plot,
  ...
  output$remainder_plot <- renderPlotly({
    ...
    # ggsave(paste0("decompose_remainder_plot_", input$region, ".tiff"), plot,
    #        device = "tiff", width = 2250, height = 1300,
    #        units = "px", dpi = 600, compression = "lzw")
    make_static_plotly(plot,
  ...
  output$boxplot1 <- renderPlotly({
    ...
    # ggsave(paste0("boxplot1_", input$season_region, ".tiff"), plot,
    #        device = "tiff", width = 2250, height = 1500, units = "px", dpi = 600)
    make_static_plotly(plot,
  ...
  output$boxplot2 <- renderPlotly({
    ...
    # ggsave(paste0("boxplot2_", input$season_region, ".tiff"), plot,
    #        device = "tiff", width = 2250, height = 1500, units = "px", dpi = 600)
    make_static_plotly(plot,
  ...
  output$boxplot3 <- renderPlotly({
    ...
    # ggsave(paste0("boxplot3_", input$season_region, ".tiff"), plot,
    #        device = "tiff", width = 2250, height = 1500, units = "px", dpi = 600)
    make_static_plotly(plot,
  ...
  output$boxplot4 <- renderPlotly({
    ...
    # ggsave(paste0("boxplot4_", input$season_region, ".tiff"), plot,
    #        device = "tiff", width = 2250, height = 1500, units = "px", dpi = 600)
    make_static_plotly(plot,
  ...
  output$boxplot5 <- renderPlotly({
    ...
    # ggsave(paste0("boxplot5_", input$season_region, ".tiff"), plot,
    #        device = "tiff", width = 2250, height = 1500, units = "px", dpi = 600)
    make_static_plotly(plot,
  ...
  output$observed_fitted <- renderPlotly({
    ...
    # ggsave(paste0("observed_fitted_", input$diag_region, ".tiff"), p, device = "tiff", 
    #        width =2250, height = 1300, units="px", dpi = 600, compression="lzw")
  ...
  output$qq_plot <- renderPlotly({
    ...
    # ggsave(paste0("qq_plot_", input$diag_region, ".tiff"), p, device = "tiff",
    #        width = 2250, height = 1300, units = "px", dpi = 600, compression = "lzw")
    make_static_plotly(p,
  ...
  output$response_fitted_plot <- renderPlotly({
    ...
    # ggsave(paste0("response_fitted_plot_", input$diag_region, ".tiff"), p, device = "tiff",
    #        width = 2250, height = 1300, units="px", dpi = 600, compression="lzw")
    make_static_plotly(p,
  ...
  output$combined_plot <- renderPlotly({
    ...
    combined %>%
      ...
      config(
        ...
        toImageButtonOptions = list(format = "png", filename = "combined_plot"),
        displaylogo = FALSE
      )
  })
  ...
  # ------- Combined Heatmaps --------
    ...
    # ggsave("combined_grid.tiff", plot = combined_grid, width = 10.2, height = 10, dpi = 600)
  ...
  output$download_heatmap <- downloadHandler(
    ...
    content = function(file) {
      ...
      # ggsave(file, plot = combined_grid, width = 10.2, height = 10, dpi = 600, device = "png")
    }
  )
